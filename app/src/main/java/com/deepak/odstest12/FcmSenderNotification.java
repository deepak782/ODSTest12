...
public class FcmSenderNotification {
    ...
    private final String fcmServerKey="AAAAEDuhfvA:APA91bGMO8m0x6RrCrnh8PLQL8B2DjczNUVmeiThW_75KIIbbuGCKRODY248UJ7VVk-8026LO82f31lcJNA4z4X511W3J4Jq1mnEJjMfUsDhjZoAxat22zrxwsE3p3hLerow4NiIhZ4O";

    public FcmSenderNotification(String userFcmToken, String title, String body, Context mContext, Activity mActivity) {
